...
public class CustomerBooking extends JFrame {
	...
	public CustomerBooking(String p, String p2) {
		...
		ExitButton.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/Exit-.png")));
		ExitButton.setFont(new Font("Arial Black", Font.PLAIN, 12));
		ExitButton.setBounds(1024, 8, 94, 23);
		...
		ImageLabel.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/Jetski-.jpg")));
		ImageLabel.setBounds(47, 37, 187, 144);
		panel_7.add(ImageLabel);
		
		JLabel ImageLabel_1 = new JLabel("");
		ImageLabel_1.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/room.jpg")));
		ImageLabel_1.setBounds(316, 92, 275, 183);
		panel_7.add(ImageLabel_1);
		
		JLabel ImageLabel_2 = new JLabel("New label");
		ImageLabel_2.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/cycling-.jpg")));
		ImageLabel_2.setBounds(57, 255, 181, 113);
		panel_7.add(ImageLabel_2);
		
		JLabel ImageLabel_3 = new JLabel("New label");
		ImageLabel_3.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/dinner-.jpg")));
		...
		ImageLabel_4.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/Jetski-.jpg")));
		ImageLabel_4.setBounds(72, 62, 182, 150);
		panel_10.add(ImageLabel_4);
		
		JLabel ImageLabel_5 = new JLabel("");
		ImageLabel_5.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/homestay.jpg")));
		ImageLabel_5.setBounds(316, 130, 275, 164);
		panel_10.add(ImageLabel_5);
		
		JLabel ImageLabel_6 = new JLabel("");
		ImageLabel_6.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/dinner-.jpg")));
		ImageLabel_6.setBounds(72, 313, 200, 133);
		panel_10.add(ImageLabel_6);
		
		JLabel ImageLabel_7 = new JLabel("");
		ImageLabel_7.setIcon(new ImageIcon(CustomerBooking.class.getResource("/Image/island hopping-.jpg")));
